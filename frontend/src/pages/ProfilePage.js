    ...
    return (
        <Row>
            <Col md={3}>
                ...
                {success && <DisplayMessage variant="success">Profile Updated</DisplayMessage>}
            ...
            <Col md={9}>
                <h2>My Orders</h2>
                {loadingOrders ? <SpinnerComponent /> : errorOrders ? <DisplayMessage>{errorOrders}</DisplayMessage> :
                    (
